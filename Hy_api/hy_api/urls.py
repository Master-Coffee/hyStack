...
schema_view = get_schema_view(
    openapi.Info(
        title="Hy API",
        default_version="v1",
        description="API endpoints for Hy API ",
...
admin.site.site_header = "Hy API Admin"

admin.site.site_title = "Hy API Admin Portal"

admin.site.index_title = "Welcome to Hy API Portal"
